<script type="text/javascript">
    ...
    <div id="list_brand">
      ...
      <div class="content_list_brand">
        <ul>
          <li><a href=""><img src="<?php echo base_url();?>public/images/banner_1679091c.jpg" alt=""/></a></li>
    ...
    <div id="footer">
      <div id="footer_top">
        <div id="copyright">® Bản quyền thuộc về Tung Mobile</div>
        <div id="nav_footer"> 
      ...
      <div id="footer_bottom">
        <div class="l" style="margin-right:5px;"> <a href="<?php echo base_url(); ?>" style="margin-top: 0px;" id="logo_bottom" class=""><img style="max-width: 162px;" src="<?php echo base_url();?>public/images/logo.png" alt="logo" /></a>										        <!--logo_bottom-->
          ...
          <div class="contact line_height20"> 
            ...
            <span class="blue"><strong><a class="blue" target="_blank" href="https://goo.gl/maps/zFVWn7EcqsT2">( Xem bản đổ )</a></strong></span><br />
          </div>
          <div class="clear space2"></div>
          <p>Thiết kế bởi <b><a target="_blank" href="https://www.facebook.com/bach.ict">Bach Nx</a></b></p>
        ...
        <div class="r" style="width:331px;background:url(<?php echo base_url();?>public/images/bg_footer_space.jpg) left center no-repeat; padding-left:10px;">
          <div id="connect_us">
            ...
            <a href="https://www.facebook.com/tungmobilephone" target="_blank" class="nomar_l"><i class="bg cn_fb"></i> Facebook</a> <a href="https://twitter.com/" target="_blank"><i class="bg cn_tw"></i> Twitter</a> <a href="#"><i class="bg cn_go"></i> Google+</a> </div>
          <div class="clear"></div>
    ...
    <table bgcolor="#FFFFFF" border="0" style="text-align:center;padding-right:10px;" width="260">
      <tbody>
        <tr>
          ...
          <td><strong style="font-size: 17px; color: #ff0000;">Hotline: 0966.887.444</strong></td>
        </tr>
        <tr>
          <td style="50px;"><img src="<?php echo base_url();?>public/images/s_mail.png" alt="supporter" style="margin-left: 5px;" /></td>
          <td><p class="Email"><a href="mailto:tungmobilehd@gmail.com">tungmobilehd@gmail.com</a></p></td>
        </tr>
        <tr>
          <td style="50px;"><img src="<?php echo base_url();?>public/images/s_female.png" alt="supporter" /></td>
          <td><strong class="TenNick">C/S khách hàng:</strong> <span class="MayLe"> <strong style="font-size: 14px; color: #ff0000;">0966.887.444</strong></span><br />
            <span class="all"><a href="ymsgr:sendim?bachnx92&m=Xin chào"><img src="http://opi.yahoo.com/online?u=bachnx92&m=g&t=1&l=us" /></a> <a href="skype:northstar.vn"><img height="20px" src="<?php echo base_url() ;?>public/images/skype_online.png" style="border: none;" width="64px" /></a></span></td>
        </tr>
        <tr>
          <td style="50px;"><img src="<?php echo base_url();?>public/images/s_male.png" alt="supporter" /></td>
          <td><strong class="TenNick">Kinh doanh:</strong> <span class="MayLe"> <strong style="font-size: 14px; color: #ff0000;">03206.288.999</strong></span><br />
            <span class="all"><a href="ymsgr:sendim?bachnx92&m=Xin chào"><img src="http://opi.yahoo.com/online?u=bachnx92&m=g&t=1&l=us" /></a> <a href="skype:northstar.vn"> <img height="20px" src="<?php echo base_url() ;?>public/images/skype_online.png" style="border: none;" width="64px" /></a></span></td>
        </tr>
