  ...
  <div class="box_column_right">
      ...
      <form method="post" enctype="multipart/form-data" action="<?php echo base_url()."home/cart/updatecart"; ?>" onsubmit="return check_field()">
        ...
        <table cellpadding="5" border="1" bordercolor="#CCCCCC" style="border-collapse:collapse; width:100%; ">
          <tbody>
            ...
            <tr>
              <td colspan="4"><div class="support_in_cart"> Bạn gặp khó khăn trong việc đặt hàng? Vui lòng nhấc máy để được trợ giúp: &nbsp;&nbsp;<b class="font18 red">097.444.9229</b> </div></td>
    ...
    <div class="contact_view cart_view" style="color: rgb(255, 0, 0);"> </div>
        ...
        <div class="c3_col_1" style="margin: 0;">
          ...
          <div class="c3_box">
            <a title="Thanh toán trực tuyến an toàn dùng tài khoản Ngân hàng (VietcomBank, TechcomBank, Đông Á, VietinBank, Quân Đội, VIB, SHB,... và thẻ Quốc tế (Visa, Master Card...) qua Cổng thanh toán trực tuyến BảoKim.vn" class="cart_step2_tiep cart_step3_send2" href="https://www.baokim.vn/payment/customize_payment/product?business=bachnx92@gmail.com&product_name=<?php foreach($cart as $key => $value){ ?><?php echo $this->string->cut($value['name'],20,"..."); ?>|Giá:<?php $total_1 = $value['price'] * $value['qty'];  echo number_format($total_1) ;?>VNĐ|Số lượng:<?php echo $value['qty'] ;?><?php } ?>&product_price=<?php echo $this->cart->total(); ?>&product_quantity=<?php echo $value['qty'] ;?>&total_amount=<?php echo $this->cart->total(); ?>" target="_blank"><img src="http://developer.baokim.vn/uploads/baokim_btn/thanhtoan-l.png" alt="thanh toán"  /></a>
          </div>
        </div>
          ...
          <div class="c3_box">
            <div class="tbl_cart3">
              ...
              <div style="text-align: right;padding-right: 22px;">
                ...
                <a href="<?php echo base_url()."gio-hang.html"; ?>?step=1" class="cart_quaylai"></a> 
              </div>
            </div>
            <div class="clear"></div>
          </div>
